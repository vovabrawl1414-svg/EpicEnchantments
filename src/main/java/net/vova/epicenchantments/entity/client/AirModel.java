...
import net.vova.epicenchantments.entity.animations.ModAnimationDefinitions;
...
public class AirModel<T extends Entity> extends HierarchicalModel<T> {
	private final ModelPart rhino;
	private final ModelPart head;

	public AirModel(ModelPart root) {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(((AirEntity) entity).idleAnimationState, ModAnimationDefinitions.AIR_IDLE, ageInTicks, 1f);
		this.animate(((AirEntity) entity).attackAnimationState, ModAnimationDefinitions.RHINO_ATTACK, ageInTicks, 1f);
	}
